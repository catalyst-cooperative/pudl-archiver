...
fake_baseline_datapackage.resources = [fake_baseline_datapackage.resources[1]]
...
fake_new_datapackage_fail1.resources.pop(-2)
...
fake_new_datapackage_fail2.resources.pop(-3)
