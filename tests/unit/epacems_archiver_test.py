...
fake_baseline_datapackage = DataPackage.model_validate_json(
    json.dumps(
        {
            "name": "epacems",
            "title": "Test EPACEMS",
...
fake_new_datapackage_fail1 = DataPackage.model_validate_json(
    json.dumps(
        {
            "name": "epacems",
            "title": "Test EPACEMS",
...
fake_new_datapackage_fail2 = DataPackage.model_validate_json(
    json.dumps(
        {
            "name": "epacems",
            "title": "Test EPACEMS",
