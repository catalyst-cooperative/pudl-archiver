...
inputs for the `matrix` are set (line 28).
...
## Current PUDL Sustainers

### Gigawatt Tier (≥$25,000/year)

<a href="https://rmi.org">
<img alt="RMI" src="./images/logos/RMI.png" width="600px">
</a>

<a href="https://gridlab.org">
<img alt="RMI" src="./images/logos/GridLab.png" width="600px">
</a>

### Megawatt Tier (≥$16,000/year)

<a href="https://zero.lab.princeton.edu">
<img alt="RMI" src="./images/logos/ZEROLab.png" width="400px">
</a>
...
<a href="https://sloan.org/programs/research/energy-and-environment">
<img alt="Alfred P. Sloan Foundation" src="./images/logos/Sloan.png" width="400px">
</a>

The PUDL Project has been supported by three grants from the
[Alfred P. Sloan Foundation's Energy and Environment Program](https://sloan.org/programs/research/energy-and-environment)
in 2019, 2021, and 2024.

### National Science Foundation

<a href="https://new.nsf.gov/funding/opportunities/pathways-enable-open-source-ecosystems-pose">
<img alt="NSF POSE" src="./images/logos/NSF.png" width="400px">
</a>
