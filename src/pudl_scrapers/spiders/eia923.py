"""Scrapy spider for downloading the EIA-923 data."""
...
class Eia923Spider(scrapy.Spider):
    ...
    def all_forms(self, response):
        ...
        links = response.xpath(
            "//table[@class='simpletable'][1]" "//td[2]" "/a[contains(text(), 'ZIP')]"
        )
    ...
    def parse_form(self, response):
        ...
        Yields:
            items.Eia923
        """
        path = self.output_dir / f"eia923-{response.meta['year']}.zip"
